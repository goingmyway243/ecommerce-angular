      ...
      @if (items().length > 0) {
        <div class="cart-layout">
          <div class="items-list">
            @for (item of items(); track item.id) {
              <div class="cart-item">
                ...
                <button class="btn-remove" (click)="cartService.removeFromCart(item.id)">×</button>
              </div>
            }
          </div>
          ...
          <div class="summary">
            ...
            <button class="btn-clear" (click)="cartService.clearCart()">Clear Inventory</button>
          </div>
        </div>
      } @else {
        <div class="empty-state">
          ...
          <a routerLink="/" class="btn-shop">Back to Shop</a>
        </div>
      }
    </div>
  `,
